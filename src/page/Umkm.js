...
import Product1Image from '../assets/image/umkm/products_mebel.png';
...
import UmkmMebelImage from '../assets/image/umkm/umkm_mebel.jpg';
import UmkmKeripikImage1 from '../assets/image/umkm/umkm_keripik_1.jpg';
import UmkmKeripikImage2 from '../assets/image/umkm/umkm_keripik_2.jpg';
import UmkmKeripikImage3 from '../assets/image/umkm/umkm_keripik_3.jpg';
import UmkmKateringImage from '../assets/image/umkm/umkm_katering.jpg';
import UmkmAnyamanImage1 from '../assets/image/umkm/umkm_anyaman_1.jpg';
import UmkmAnyamanImage2 from '../assets/image/umkm/umkm_anyaman_2.jpg';
import UmkmAnyamanImage3 from '../assets/image/umkm/umkm_anyaman_3.jpg';
import UmkmKedelaiImage from '../assets/image/umkm/umkm_kedelai.jpg';
    ...
    return (
        <Layout color='gray.800'>
            ...
            <UmkmSectionB
                ...
                description2='Kegiatan utama usaha ini adalah memproduksi berbagai jenis kerajinan yang menggunakan bahan dasar utama bambu. Beberapa bentuk kerajinan yang dihasilkan, antara lain keranjang makanan, keranjang buah, tempat kue, tempat tisu, kap lampu, dan berbagai macam bentuk lain yang biasanya dibutuhkan oleh masyarakat. Proses produksi sebagian besar dikerjakan secara manual (handmade) dengan menggunakan alat-alat sederhana, seperti pisau potong, pisau irat, gergaji, dll. Hal inilah yang menjadikan produk kerajinan bambu Desa Mertelu menarik bagi banyak konsumen, baik lokal maupun luar daerah, termasuk wisatawan mancanegara.'
                image1={UmkmAnyamanImage1}
                image2={UmkmAnyamanImage2}
                image3={UmkmAnyamanImage3}
            />
            <UmkmSectionA
                title='Olahan Kedelai'
                description='Kedelai adalah bahan pangan yang sangat populer di Asia, khususnya di negara-negara seperti Jepang, China, dan Korea. Olahan kedelai mencakup berbagai jenis produk yang dibuat dari bahan baku kedelai, seperti tepung kedelai, susu kedelai, tahu, tempe, dan minyak kedelai. Di Desa Mertelu sendiri, kedelai diolah menjadi produk tempe dan tahu. Kedua produk tersebut sangat digemari oleh warga sehingga permintaan akan olahan kedelai tersebut cukup tinggi. Setiap bulan, masyarakat Desa Mertelu dapat memproduksi hingga 10.000 potong tempe.'
